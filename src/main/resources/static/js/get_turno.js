    ...
    (function(){
      ...
      //recorremos la colección de peliculas del JSON
         for(turno of data){
            ...
            // Verificar si turno.odontologo y turno.paciente están definidos


            turnoRow.innerHTML = '<td>' + updateButton + '</td>' +
                     '<td class="td_fechaTurno">' + turno.fechaTurno + '</td>' +
                     '<td class="td_odontologoId">' + turno.pacienteId + '</td>' +
                     '<td class="td_pacienteId">' + turno.odontologoId + '</td>' +
                    '<td>' + deleteButton + '</td>';
